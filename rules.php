	...
	<div id="main">
		...
		<div class="post">
			...
			<div class="post_body">
				...
				<p>Rules</p>
				<ul class="rules">
				<li>Hack In consists of puzzles involving technical concepts. Clues may be present ANYWHERE - source code being the most common place to look.</li>
				<li>You have to register to participate</li>
				<li>The first 10 or so levels have been designed to ensure that UG1 students can go through them provided they have sound ITWS1 concepts and a keen mind.</li>
				<li>Please play fairly. Any malicious attempt will result in the IP and username being blocked from the portal</li>
				<li>Feel free to ask doubts/hints/share feedback on the forums. However, sharing answers is not permitted.</li>
				<li>The portal will remain open till Sunday. The contest may be extended if user interest persists.</li>
				<li>Have fun! :)</li>
				</ul>
				

				<blockquote>
				<p>When solving problems, dig at the roots instead of just hacking at the leaves.
				</p>
