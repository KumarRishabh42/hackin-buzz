...
-->
	...
	<div id="main">
		...
		<div class="post">
			...
			<div class="post_body">
				To get started/continue where you left, click <a href="redirect.php">here</a><br />


				<blockquote>

					<p>There are few sources of energy so powerful as a procrastinating college student</p>
