...
if($ip == "1010.1.39.203" || $ip == "1010.1.39.126" || $ip == "10.1.40.110"){
	        die("Unauthorized");
}
...
-->
	...
	<div id="main">
		...
		<div class="post">
			...
			<form method="post" action="login_check_new.php">
			...
			<input type="password" name="repassword" id="repassword" class="password" /><br /><br />
			
			<p class="txtleft"><label for="captcha">For security reasons, please type the text in the image below:</label></p>
			

			<span style="">
      					<img id="captcha" src="./mycpt/chuchu/securimage_show.php" alt="CAPTCHA Image" align="center"/>
			</span>
			<br/>
			<input type="text" name="captcha_code" size="10" maxlength="6" id = "captcha"/> <br /><br />
