<?
$fp=fopen("/tmp/sometime.txt","w");
fwrite($fp,$_SERVER["HTTP_REFERER"]);
if($_SERVER["HTTP_REFERER"]!="http://felicity.iiit.ac.in/~buzz//hackin/registrationnew.php" && $_SERVER['HTTP_REFERER']!="http://felicity.iiit.ac.in/~buzz/hackin/registrationnew.php"){
	die("Go Away!");
}
include "config.php";
